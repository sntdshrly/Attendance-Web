...
function my_autoloader($class) {
    ...
    include 'view/mahasiswa-view.php';
}
...
//                $prevResult = $link->query($prevQuery);
                ...
                $link->query("INSERT INTO asisten (nrp, nama_mahasiswa) VALUES ('".$nrp."', '".$nama_mahasiswa."')");
...
header("Location: ../index.php?webmenu=import-mahasiswa");