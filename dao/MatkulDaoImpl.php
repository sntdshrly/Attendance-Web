...
class MatkulDaoImpl
{
    public function fetchAllMatkul()
    {
        ...
        $query = 'SELECT p.id_prodi, p.nama_prodi AS "prodi_name", m.kode_mk, m.nama_mk, m.prodi_id_prodi, m.jumlah_sks FROM matkul m LEFT OUTER JOIN prodi p ON m.prodi_id_prodi = p.id_prodi';
